...
@Component({
  ...
  template: `
    ...
    <p *ngIf="track.genus != 'Arabidopsis' && track.genus != 'Cucumis' && track.genus != 'Fragaria' && track.genus != 'Prunus'"><a href="https://intermine.legumefederation.org/legumemine/bag.do?type=Gene&text={{geneListFormatted}}">Create gene list in LegumeMine</a></p>
    <p *ngIf="track.genus === 'Arabidopsis'"><a href="https://apps.araport.org/thalemine/bag.do?type=Gene&text={{geneListFormatted}}">Create gene list in ThaleMine</a></p>
    <p *ngIf="track.genus === 'Cucumis' || track.genus === 'Fragaria' || track.genus === 'Prunus'"><a href="https://phytozome.jgi.doe.gov/phytomine/bag.do?type=Gene&text={{geneListFormatted}}">Create gene list in PhytoMine</a></p>
    <p>Genes:</p>
    <ul>
